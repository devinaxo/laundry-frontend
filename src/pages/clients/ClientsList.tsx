    ...
    columnHelper.display({
      ...
      cell: ({ row }) => (
        <Button
          ...
          className="text-primary hover:text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:text-blue-300 dark:hover:bg-blue-950"
        >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        <span
                          className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${client.active
                              ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400'
                              : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'
                            }`}
                        >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-sidebar-border">
                      ...
                      <div className="flex items-center gap-1">
                        <Button
                          ...
                          className="text-primary hover:text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:text-blue-300 dark:hover:bg-blue-950 h-8 w-8 p-0"
                          title="Ver en mapa"
                        >
                          <MapPin className="h-4 w-4" />
                        </Button>
